        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Developing intelligent systems with a focus on deep learning, computer vision, and NLP. Building end-to-end ML pipelines for data-driven solutions.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Strong foundation in core CS principles, building applications, database management, and version control for robust and scalable systems.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
